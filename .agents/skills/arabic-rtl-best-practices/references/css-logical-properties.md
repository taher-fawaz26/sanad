# CSS Logical Properties Quick Reference for Arabic RTL
...
## Arabic Font Stack Recommendations

### Sans-Serif (recommended for web)
```css
font-family: 'Cairo', 'Tajawal', 'Alexandria', 'Noto Sans Arabic', 'Arial Arabic', sans-serif;
```

### Serif (for formal/print-style content)
```css
font-family: 'Tajawal', 'Cairo', 'Noto Sans Arabic', serif;
```

### Monospace (for code with Arabic comments)
```css
font-family: 'Tajawal', 'Noto Sans Mono', monospace;
```
