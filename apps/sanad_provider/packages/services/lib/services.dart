...
/// service-requests, plus the branch-service-assignment picker (which now
/// sources from the same real `GET /services` contract).
///
/// Public API surface:
/// * Register the module: add [ServicesModule] to the app [ModuleRegistry].
/// * Load services via [GetServicesListUseCase].
