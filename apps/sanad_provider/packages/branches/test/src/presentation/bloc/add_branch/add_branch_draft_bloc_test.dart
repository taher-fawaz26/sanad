...
void main() {
  ...
  group('AddBranchDraftBloc', () {
    late AddBranchDraftBloc cubit;

    setUp(() {
      cubit = AddBranchDraftBloc();
    });
    ...
    group('updateBasicInfo', () {
      blocTest<AddBranchDraftBloc, AddBranchDraft>(
        'updates branch name',
        build: () => cubit,
    ...
    group('data survives step transitions', () {
      test('all draft fields persist across cubit lifetime', () async {
        ...
        // Bloc events are processed on the microtask queue — flush before
        // asserting on state (unlike the former Cubit setters which were
        // synchronous).
