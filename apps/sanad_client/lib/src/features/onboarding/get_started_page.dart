...
import 'package:sanad_client/src/features/onboarding/onboarding_language_selector.dart';
...
/// Get Started / login-method chooser (Figma `6974:25087`).
///
/// UI-only for this phase: UAE PASS, Google and Phone have no backend yet,
/// so their `onPressed` are documented no-ops. Only "Continue with Email"
/// navigates, since that's the one screen built in this phase.
                  ...
                  builder: (context, constraints) => SingleChildScrollView(
                    child: ConstrainedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'onboarding.get_started_title'.tr(),
                          ...
                          Text(
                            'onboarding.get_started_subtitle'.tr(),
                            textAlign: TextAlign.center,
                          ...
                          SizedBox(
                            height: responsiveDimension(AppSpacing.xxl),
                          ),
                          AppButton(
                            label: 'onboarding.continue_uae_pass'.tr(),
                            iconPosition: AppButtonIconPosition.left,
                            icon: AppSvgPicture.asset(AppSvgs.uaePassLogo),
                            // No backend yet — documented boundary for this
                            // phase.
                            onPressed: () {},
                          ),
                          ...
                          SizedBox(height: responsiveDimension(AppSpacing.lg)),
                          AppButton(
                            label: 'onboarding.continue_email'.tr(),
                            variant: AppButtonVariant.secondary,
                            onPressed: () => context.push(
                              OnboardingRoutes.continueWithEmail,
                            ),
                          ),
                          ...
                          Row(
                            children: [
                              Expanded(
                                child: AppButton(
                                  label: 'onboarding.continue_google'.tr(),
                                  variant: AppButtonVariant.secondary,
                                  iconPosition: AppButtonIconPosition.center,
                                  icon: SvgPicture.string(_googleLogoSvg),
                              ...
                              Expanded(
                                child: AppButton(
                                  label: 'onboarding.continue_phone'.tr(),
                                  variant: AppButtonVariant.secondary,
                                  iconPosition: AppButtonIconPosition.center,
                          ...
                          Text.rich(
                            ...
                            TextSpan(
                              ...
                              children: [
                                TextSpan(text: 'onboarding.terms_prefix'.tr()),
                                TextSpan(
                                  text: 'onboarding.terms_link'.tr(),
