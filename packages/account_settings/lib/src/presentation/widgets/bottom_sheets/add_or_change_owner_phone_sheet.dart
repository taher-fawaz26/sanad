...
/// Shows the "Enter Phone Number" bottom sheet for the signed-in owner's own
/// phone.
///
...
/// + `otp` packages (purpose `changeOwnerPhone`); returns the new national
/// phone number once verified, or `null` if dismissed.
Future<String?> showAddOrChangeOwnerPhoneSheet({
  ...
  return SheetNavigator.push<String>(
    context,
    _AddOrChangeOwnerPhoneSheetBody(initialPhone: initialPhone),
  );
}

class _AddOrChangeOwnerPhoneSheetBody extends StatefulWidget {
  const _AddOrChangeOwnerPhoneSheetBody({this.initialPhone});

  final String? initialPhone;

  @override
  State<_AddOrChangeOwnerPhoneSheetBody> createState() =>
      _AddOrChangeOwnerPhoneSheetBodyState();
}

class _AddOrChangeOwnerPhoneSheetBodyState
    extends State<_AddOrChangeOwnerPhoneSheetBody> {
