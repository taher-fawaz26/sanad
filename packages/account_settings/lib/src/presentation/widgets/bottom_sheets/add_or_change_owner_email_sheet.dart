...
/// Shows the "Enter Email" bottom sheet for the signed-in owner's own email.
///
...
/// + `otp` packages (purpose `changeOwnerEmail`); returns the new email
/// address once verified, or `null` if dismissed.
Future<String?> showAddOrChangeOwnerEmailSheet({
  required BuildContext context,
  String? initialEmail,
}) {
  return SheetNavigator.push<String>(
    context,
    _AddOrChangeOwnerEmailSheetBody(initialEmail: initialEmail),
  );
}

class _AddOrChangeOwnerEmailSheetBody extends StatefulWidget {
  const _AddOrChangeOwnerEmailSheetBody({this.initialEmail});

  final String? initialEmail;

  @override
  State<_AddOrChangeOwnerEmailSheetBody> createState() =>
      _AddOrChangeOwnerEmailSheetBodyState();
}

class _AddOrChangeOwnerEmailSheetBodyState
    extends State<_AddOrChangeOwnerEmailSheetBody> {
