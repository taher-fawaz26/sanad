...
class ProviderServiceCardData {
  ...
  /// `GET /services/analytics`, when analytics data is actually available
  /// (`dataAvailable: true`) — currently always absent, since the live
  /// backend reports `dataAvailable: false` until the booking entity ships.
  /// Falls back to a "—" placeholder rather than rendering a fake zero.
