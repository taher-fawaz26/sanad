...
class CircularMenuItem extends StatelessWidget {
  /// if [child] is passed, [icon] and [animatedIcon] are ignored.
  final IconData? icon;
  final Color? color;
  ...
  /// Custom widget content (e.g. SVG) for menu or toggle buttons.
  final Widget? child;
